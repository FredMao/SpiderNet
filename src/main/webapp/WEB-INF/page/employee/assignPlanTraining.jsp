...
String trainingId = (String)request.getAttribute("trainingId");
String pointId = (String)request.getAttribute("pointId");
String planTrainingId = (String)request.getAttribute("planTrainingId");
%>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-edit"></i> Assign Employees to Training Plan
								</h2>
							</div>
...
<input type="hidden" name="planId" id="planId" value="<%=planTrainingId%>"/>
									...
									<div class="form-group">
										...
										<div class="group">
											<label class="col-lg-2 control-label">Training Plan</label>
											<div class="col-lg-4">
												<select id="trainingPlan" name="trainingPlan" class="selectpicker" data-live-search="true">
	...
	<!-- default loading -->
	<script type="text/javascript"
		src="<%=path%>/js/spidernet/batchAddPlanTraining.js"></script>
